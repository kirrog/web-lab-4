            ...
            <form id="form">
                ...
                <div id="xText">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="coordX" value="-3" v-model="coord_x" id="x-3" checked>
                        <label class="form-check-label" for="x-3">-3</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="-2" v-model="coord_x" id="x-2">
                        <label class="form-check-label" for="x-2">-2</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="-1" v-model="coord_x" id="x-1">
                        <label class="form-check-label" for="x-1">-1</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="0" v-model="coord_x" id="x0">
                        <label class="form-check-label" for="x0">0</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="1" v-model="coord_x" id="x1">
                        <label class="form-check-label" for="x1">1</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="2" v-model="coord_x" id="x2">
                        <label class="form-check-label" for="x2">2</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="3" v-model="coord_x" id="x3">
                        <label class="form-check-label" for="x3">3</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="4" v-model="coord_x" id="x4">
                        <label class="form-check-label" for="x4">4</label>
                        <input class="form-check-input" type="checkbox" name="coordX" value="5" v-model="coord_x" id="x5">
                ...
                <div id="yButtons">
                    <div class="form-inline">
                        Y:
                        <input type="text" class="form-control" id="text_input_Y" v-model="coord_y" placeholder="[-5;5]" value="0"/>
                    </div>
                </div>
                ...
                <div id="rButtons">
                    R:
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="-3" v-model="coord_r" onclick="setR(-3)" id="r-3" checked>
                        <label class="form-check-label" for="r-3">-3</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="-2" v-model="coord_r" onclick="setR(-2)" id="r-2">
                        <label class="form-check-label" for="r-2">-2</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="-1" v-model="coord_r" onclick="setR(-1)" id="r-1">
                        <label class="form-check-label" for="r-1">-1</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="0" v-model="coord_r" onclick="setR(0)" id="r0">
                        <label class="form-check-label" for="r0">0</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="1" v-model="coord_r" onclick="setR(1)" id="r1">
                        <label class="form-check-label" for="r1">1</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="2" v-model="coord_r" onclick="setR(2)" id="r2">
                        <label class="form-check-label" for="r2">2</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="3" v-model="coord_r" onclick="setR(3)" id="r3">
                        <label class="form-check-label" for="r3">3</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="4" v-model="coord_r" onclick="setR(4)" id="r4">
                        <label class="form-check-label" for="r4">4</label>
                        <input class="form-check-input" type="checkbox" class="rCheckbox" name="coordR" value="5" v-model="coord_r" onclick="setR(5)" id="r5">
