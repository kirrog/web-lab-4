...
<div id="content" class="form-row">
    ...
    <div class="col-4" id="form">
        ...
        <input v-model="pass" id="password-text" placeholder="Your pass" class="form-control" type="password"
               style="min-width:200px" required>
        ...
        methods: {
            greet: function (event) {
                if (this.pass === this.passR) {
                    ...
                    document.getElementById("password-text").classList.contains("is-valid");
